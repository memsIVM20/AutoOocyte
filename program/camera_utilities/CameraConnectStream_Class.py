...
class CameraOperation():
    ...
    def __init__(self,obj_cam,st_device_list,n_connect_num=0,b_open_device=False,b_start_grabbing = False,h_thread_handle=None,\
        ...
        # _____
        self.image = None      # Image buffer
        self.flag = False    # Status flag
    ...
    def Open_device(self):
        if False == self.b_open_device:
            ...
            # Detect optimal network packet size (for GigE cameras only)
    ...
    def Work_thread(self):
        ...
        self.image = numArray  # Store final frame
    ...
    def Save_jpg(self):
        ...
        stParam.nBufferSize = self.n_save_image_size             # Buffer size
        stParam.nJpgQuality = 80                                 # JPG quality (ignored for BMP)
